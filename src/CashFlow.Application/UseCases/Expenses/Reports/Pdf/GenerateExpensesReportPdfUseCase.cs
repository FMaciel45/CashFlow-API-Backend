...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        // Cria a a estrutura do PDF
        var document = CreateDocument(loggedUser.Name, month);
        var page = CreatePage(document);

        // Adiciona um cabeçalho com foto e nome
        ...
        // Adiciona cada despesa ao relatório
        foreach (var expense in expenses)
        {
            var table = CreateExpenseTable(page);

            // Linha do título da despesa
        ...
        // Renderiza e retorna o PDF como byte[]
        return RenderDocument(document);
    }

    // Cria o documento base com metadados
    ...
    // Configura uma página no documento
    ...
    // Cria cabeçalho com foto de perfil e nome
    private void CreateHeaderWithProfilePhotoAndName(string name, Section page)
    {
        ...
        var pathFile = Path.Combine(directoryName!, "Logo", "ProfilePhoto.png"); // Caminho para inserir a imagem de perfil
    ...
    // Cria seção com total gasto no mês
    ...
    // Cria tabela para mostrar despesas
    ...
    // Adiciona título da despesa (com formatação especial)
    ...
    // Adiciona cabeçalho para a coluna de valores
    ...
    // Configura estilo base para informações da despesa
    ...
    // Adiciona valor formatado da despesa
    ...
    // Adiciona espaço em branco entre despesas (facilitar visualização)
    ...
    // Renderiza o documento para array de bytes
